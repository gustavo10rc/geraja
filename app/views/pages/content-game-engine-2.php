              ...
              <div class="row">
                <div class="col-md-7">
                  ...
                  <div class="alert alert-info">
                    ...
                    <p><b><label for="game-asset" style="text-align: center;">ATENÇÃO<label></b></p> 
                     <p><b><label for="game-asset" style="text-align: center;">FORMATO: As imagens dever ser em formato JPG|PNG|JPEG <br> TAMANHO: Minimo de 60X60</b></p>
              ...
              <div class="tabs">
                ...
                <div class="tabs-content">
                  ...
                  <div class="tab-item" id="alternativas-com-images">
                    ...
                    <input type="hidden" name="images-as-options" id="images-as-options" value="true">
                  </div><!-- .tab-item -->
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="alert alert-info">
                    ...
                    <p><b><label for="game-asset">Selecione o áudio que será usado como pergunta nessa questão:</label></b></p>
                  </div>
                  <div class="alert alert-info">
                    
                    <p><b><label for="game-asset" style="text-align: center;">ATENÇÃO<label></b></p> 
                     <p><b><label for="game-asset" style="text-align: center;">FORMATO: Os arquivos de áudio devem ser em formato MP3 </b></p>
