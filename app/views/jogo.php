    ...
    <div class="stage">
      ...
      <section class="game-page" id="game-page-2">
        ...
        <div style="margin-top:80px;text-align:center;">
          <img src="../public/images/turtle.png" width="100px" height="150px">
          <img src="../public/images/SETA.png" width="400px" height="100px">
          <img src="../public/images/coelho.png" width="100px" height="150px">
        <div>
